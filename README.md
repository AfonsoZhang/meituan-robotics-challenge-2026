...
2026-09-23 用户确定实机使用 ROS 2 Humble（USER-HW-20260923、USER-HW-20260923-02），与仿真同一发行版，运行在原生 Ubuntu 而非 WSL2（USER-HW-20260923-03）；Ubuntu 版本、S3 与相机的 ROS 2 接入方式尚未确认，见 Q05、Q17。
