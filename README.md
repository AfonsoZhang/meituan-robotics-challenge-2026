...
2026-09-23 用户确定实机使用 ROS 2 Humble（USER-HW-20260923、USER-HW-20260923-02），与仿真同一发行版，部署在 NUC 上的原生 Ubuntu 22.04 而非 WSL2（USER-HW-20260923-03、USER-HW-20260923-04），当前开发电脑用于开发和跑仿真，并经 SSH 隧道远程查看 NUC（USER-HW-20260923-06、USER-HW-20260923-07）；S3 用 `aubo_ros2_driver`（USER-HW-20260923-08），与控制柜的兼容性未验证；D435i 用 realsense-ros（USER-HW-20260923-09）；NUC 型号与接口、驱动在实机上的验证尚未完成，见 Q02、Q05、Q17。
