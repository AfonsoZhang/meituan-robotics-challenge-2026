...
2026-09-23 用户确定实机使用 ROS 2 Humble（USER-HW-20260923、USER-HW-20260923-02），与仿真同一发行版，部署在 NUC 上的原生 Ubuntu 22.04 而非 WSL2（USER-HW-20260923-03、USER-HW-20260923-04），当前开发电脑用于开发和跑仿真（USER-HW-20260923-06）；NUC 型号与接口、S3 与相机的 ROS 2 接入方式尚未确认，见 Q05、Q17。
