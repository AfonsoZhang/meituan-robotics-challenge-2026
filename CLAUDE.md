...
2026 美团挑战赛参赛工作区，目前**没有源码、没有构建/测试命令**，全部产出是中文 Markdown 分析文档 + 归档的原始比赛资料。工作内容是「把规则 PDF、用户口头确认的硬件决策、厂商资料整理成可追溯的方案文档」，所以本仓库的核心不是代码结构，而是**事实溯源约定**。动手前先读 `AGENTS.md`、`README.md`、`docs/open-questions.md`。
